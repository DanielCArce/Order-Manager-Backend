import {createCompany, findCompany, getAllCompanies, updateInfo, deleteClient} from '../db/Clients.js'
...
export async function deleteCompany(request, response, next) {
    try {
        await deleteClient(Number(request.params.companyID))
